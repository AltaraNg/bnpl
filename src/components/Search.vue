            ...
            <div class="max-w-5xl bg-white rounded-xl shadow-lblue">
                <div class="flex w-full items-center">
                    ...
                    <div class="flex justify-center items-center py-2 md:py-4 px-4">
                        <button type="button"
                            class="inline-flex items-center rounded-full border border-transparent bg-primary px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-0">

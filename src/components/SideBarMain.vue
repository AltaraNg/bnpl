<template>
  <div class="!pt-0">
            ...
            <div class="flex flex-shrink-0 bg-gray-700 p-4">
              <a href="#" class="group block flex-shrink-0">
                <div class="flex items-center">
                  <div>
                    <img class="inline-block h-10 w-10 rounded-full" src="../assets/images/logo.png" alt="Altara Credit" />
                  </div>
                  <div class="ml-3">
                    <p class="text-base font-medium text-white">Tofm Cook</p>
    ...
    <div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
      ...
      <div class="flex min-h-0 flex-1 flex-col bg-white border-r border">

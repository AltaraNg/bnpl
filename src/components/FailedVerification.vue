<template>
    <div class="grid grid-cols-1 justify-items-center bg-green-400p py-8">
        ...
        <button type="button"
            class="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-3 py-2 text-sm font-medium leading-4 text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-0 min-w-[250px] justify-center mt-8">Go
            Back</button>
    </div>
</template>
